...
public class MementoEverydayDemo {
	...
	private static Employee deserialize() {
		Employee emp = null;
		try {
			FileInputStream fileIn = new FileInputStream("src/BehavioralPattern/MementoPattern/employee.ser");
	...
	private static void serialize(Employee emp) {
		...
		try {
			FileOutputStream fileOut = new FileOutputStream("src/BehavioralPattern/MementoPattern/employee.ser");
